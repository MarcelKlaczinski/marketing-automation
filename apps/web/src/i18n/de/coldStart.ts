export default {
  ...
  phase1: {
    ...
    idleDescription: 'Klicke "Fragen generieren", um den Voice-Refinement-Prozess zu starten. Du erhältst dann ca. 10 Fragen zur Marke.',
  ...
  phase2: {
    ...
    idleDescription: 'Klicke "Analyse starten" — die Pipeline ermittelt automatisch die Top 3–5 Wettbewerber und analysiert deren Keywords.',
