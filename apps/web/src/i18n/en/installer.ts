export default {
  ...
  intro: '[EN] This wizard guides you through configuring all external services. You can skip individual steps and return later.',
  alreadyInitialized: '[EN] The system has already been set up. You can reconfigure or re-verify individual adapters here.',
  ...
  steps: {
    intro: {
      title: '[EN] Welcome',
      description: '[EN] This platform automates SEO and content workflows. Before you can start, some external services need to be configured.',
      timeEstimate: '[EN] Estimated time: 30-60 minutes',
    },
    core: {
      title: '[EN] Core Infrastructure',
      description: '[EN] Database and Redis. These are configured via environment variables and cannot be changed in the browser.',
    ...
    smtp: {
      ...
      consequenceIfSkipped: '[EN] Magic-link login will be logged to the console (dev mode). Cost alerts and notifications will not be sent.',
      fields: {
        host: '[EN] SMTP Host',
        port: '[EN] Port',
        user: '[EN] Username',
    ...
    anthropic: {
      ...
      description: '[EN] Required for cold-start synthesis, article generation, and schema extensions.',
      consequenceIfSkipped: '[EN] The following features are unavailable: cold-start, article generation, schema extraction, internal linking. Effectively: almost everything.',
      fields: {
        apiKey: '[EN] API Key',
      },
    ...
    replicate: {
      ...
      consequenceIfSkipped: '[EN] Hero image generation in the article pipeline is unavailable. Articles will be created without a hero image.',
      fields: {
    ...
    r2: {
      ...
      consequenceIfSkipped: '[EN] Replicate does not work without R2 (images cannot be stored). Indirect consequence: no article generation.',
      fields: {
    ...
    dataforseo: {
      title: '[EN] DataForSEO',
      description: '[EN] Provides SERP data and keyword volume for cold-start and article research.',
      consequenceIfSkipped: '[EN] Cold-start competitor analysis, cluster plan, and article research do not work. Cold-start is effectively blocked.',
      fields: {
        login: '[EN] Login',
        password: '[EN] Password',
      },
    ...
    githubApp: {
      ...
      consequenceIfSkipped: '[EN] Astro Sync is unavailable. Articles remain in the DB and must be manually copied to the Astro repo.',
      fields: {
        appId: '[EN] App ID',
    ...
    summary: {
      ...
      readyDescription: '[EN] All required adapters are configured. Click Finish to proceed to the app.',
      partialTitle: '[EN] Setup partially complete',
      partialDescription: '[EN] Some adapters are skipped. You can complete them under Settings at any time.',
