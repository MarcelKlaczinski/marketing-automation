export default {
  ...
  create: {
    ...
    contextIntro:
      "Optional: Describe brand voice, target audience, content strategy. You can also auto-generate this later in the Cold-Start phase.",
  ...
  detail: {
    ...
    settingsStub: "Project settings will be implemented in Spec 34 Session 3.",
    tabs: {
      overview: "Overview",
  ...
  overview: {
    ...
    contextHint:
      "Description of the brand, target audience, and content strategy. Used in Cold-Start and Article Generation as system prompt.",
  ...
  settings: {
    ...
    astroRepo: {
      ...
      installationIdHint:
        'Numeric ID. Available via "bun --filter @marketing-auto/adapter-astro-sync list-installations".',
    ...
    publishDomain: {
      ...
      field: "Domain",
      placeholder: "e.g. kiwissenraum.de",
    },
    pagespeed: {
    ...
    costLimits: {
      title: "Cost Limits",
      description:
        "Maximum API spend per day and month (in EUR). Pipelines are paused when a limit is exceeded.",
      daily: "Per Day",
      monthly: "Per Month",
