export default {
  intro: 'Cold-Start initializes a new project with Brand Voice, Competitor Analysis, Cluster Plan, and Cornerstone Articles. The 5 phases can be run individually or sequentially.',
  ...
  phase1: {
    ...
    idleDescription: 'Click "Generate Questions" to start the voice refinement process. You\'ll receive ~10 questions about the brand.',
    generateQuestions: 'Generate Questions',
    questionsRunning: 'Generating questions...',
    questionsFailed: 'Question generation failed',
    answerHint: 'Answer the questions as thoroughly as possible. The answers will be used to create the marketing context.',
  ...
  phase2: {
    ...
    idleDescription: 'Click "Start Analysis" — the pipeline will automatically identify the top 3–5 competitors and analyze their keywords.',
  ...
  phase3: {
    ...
    idleDescription: 'Click "Create Cluster Plan" — the pipeline will propose 3–7 topic clusters each with a cornerstone keyword.',
  ...
  phase4: {
    ...
    idleDescription: 'Click "Generate Cornerstones" — one cornerstone article proposal will be created per cluster.',
  ...
  phase5: {
    ...
    idleDescription: 'Click "Generate Checklist" — you\'ll receive a personalized list of next steps.',
