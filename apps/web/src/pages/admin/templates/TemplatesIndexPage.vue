  ...
  <q-page class="q-pa-md">
    <div class="row items-center q-mb-md">
      ...
      <q-btn
        flat
        icon="refresh"
        :label="$t('admin.templates.reload')"
        @click="loadTemplates"
      />
    </div>
    ...
    <div v-else>
      ...
      <div v-if="templates.length === 0" class="text-center text-grey-6 q-pa-xl">
        ...
        <div>Keine Templates registriert</div>
      </div>
    </div>
...
import TemplateCard from 'src/components/admin/templates/TemplateCard.vue';
import TemplatePreviewModal from 'src/components/admin/templates/TemplatePreviewModal.vue';

interface TemplateFixtureMeta {
  key: string;
  name: string;
  description: string;
}
