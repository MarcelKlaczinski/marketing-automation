    ...
    fixtures: [
      {
        ...
        slides: async (theme) => {
          const input = proConVerdictInputSchema.parse({
            theme, locale: "de", slideIndex: 0, brandTokens: DEFAULT_BRAND,
            generated: {
              ...
              pros: ["Beste Ästhetik out-of-the-box", "Konsistenz durch --sref & --cref", "Schnelle Iteration im Web-Interface", "Starke Community & Ressourcen"],
              cons: ["Kein API für Automatisierung", "Text im Bild schwach", "Schwer aus dem MJ-Look auszubrechen", "Kein lokales Hosting möglich"],
      ...
      },
      {
        ...
        slides: async (theme) => {
          const input = proConVerdictInputSchema.parse({
            theme, locale: "en", slideIndex: 0, brandTokens: DEFAULT_BRAND,
            generated: {
              toolName: "Notion AI",
              ...
              pros: ["Already inside your workspace", "Great at summarising docs", "No extra tool to manage"],
              cons: ["Expensive add-on price", "Weaker than standalone LLMs", "Locked inside Notion only"],
        ...
        slides: async (theme) => {
          const input = proConVerdictInputSchema.parse({
            ...
            generated: {
              ...
              prosHeader: "Stärken",
              consHeader: "Schwächen",
              pros: ["Beste IDE-Integration im Markt", "Autocomplete auf Senior-Niveau nach Einarbeitung", "PR-Zusammenfassungen sparen 30 Min pro Review", "Sicherheits-Scanning direkt im Editor"],
              cons: ["Teuerste Option: 39 $/User/Mo im Enterprise-Plan", "Privacy-Bedenken: Code geht an GitHub-Server", "Halluziniert veraltete APIs bei Legacy-Code", "Kein Offline-Modus für Air-Gap-Umgebungen"],
