...
export const SINGLE_TOOL_SPOTLIGHT_FIXTURES: MockFixtureMap = {
  ...
  "edge-max": {
    ...
    generatedContent: {
      ...
      strengths: [
        "SOC2 Type II zertifiziert, DSGVO-konform für EU-Deployments verfügbar.",
        "Unbegrenzte Workspaces und Nutzerlizenzen ohne Aufpreis inklusive.",
        "REST API plus Webhooks für sämtliche Workflow-Aktionen nutzbar.",
        "Dedizierter 24/7 Enterprise-Support mit vertraglicher SLA-Garantie.",
      ],
      weaknesses: [
        "Steile Lernkurve besonders bei komplexen Multi-Step-Workflows spürbar.",
        "Onboarding-Prozess dauert typischerweise zwei bis vier volle Wochen.",
        "Keine native Mobile-App für iOS oder Android zum Zeitpunkt des Tests.",
        "Preis für kleine und mittlere Unternehmen nur schwer zu rechtfertigen.",
      ],
      caption:
