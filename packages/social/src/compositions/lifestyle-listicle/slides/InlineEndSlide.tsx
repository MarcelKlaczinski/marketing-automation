/**
 * Spec 65.8 — lifestyle-listicle inline end slide.
 *
 * Family-B InlineEndSlide variant — same `editorial` SlideComposition as
 * story-arc-clickbait's InlineEndSlide but with lifestyle-specific copy
 * defaults (the caller still passes the actual end-content; this slide is
