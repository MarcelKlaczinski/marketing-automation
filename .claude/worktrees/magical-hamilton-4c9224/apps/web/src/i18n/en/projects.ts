export default {
  ...
  overview: {
    ...
    recentAllLink: "View all articles",
  ...
  settings: {
    ...
    astroRepo: {
      ...
      localPath: "Local Path (Dev Preview)",
      localPathHint: "Absolute path to your locally cloned Astro repo — only needed for local preview.",
      collectionPathsTitle: "Preview URL Paths",
      collectionPathsHint: "Path template per collection. Tokens: {locale}, {collection}, {slug}. Without an entry the smart default /{locale}/{collection}/{slug} is used.",
      collectionPathsCollection: "Collection",
      collectionPathsTemplate: "Path template",
      collectionPathsAdd: "Add collection",
      collectionPathsEmpty: "No entries — smart default is used",
    },
    publishDomain: {
